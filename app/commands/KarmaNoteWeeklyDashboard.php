...
class KarmaNoteWeeklyDashboard extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'karmanote:weeklydashboard';
	 ...
	 * @var string
	 */
	protected $description = 'Command for Weekly Dashboard snapshot send on email';
	...
	{ 	  
		...
		$getusers = DB::table('users')
						...
						->where('users.subscribed','=','0')
						//->whereIn('users.id',array(525))      
