	...
	<!-- Header -->
		<table width="100%" style="text-align:left;padding:8px 10px;color: #626262;border-bottom:1px solid #ccc;margin-bottom:5px">
            <tbody>
                ...
                <th style="color:#626262;font-size: 14px;text-align: center;color:#626262">Your KarmaMeeting request has been accepted by <br>
				{{$giverDetail->fname." ".$giverDetail->lname}}</th>
	                </th>
	            </tr>
	        </tbody>  
        </table>
		...
		<div style="width:280px;background:#fff;border:1px solid #ccc;margin:0 auto;padding:5px">
			<div style="width:90px;float:left">
				...
				@else
					<img height="87px" width="82px" alt="" src="{{$giverDetail->piclink}}">
				@endif 	
			</div>
			<div>
				<h4 style="color: #38bb95;font-size: 16px;font-weight: normal;margin: 0 0 4px;">{{$giverDetail->fname." ".$giverDetail->lname}}</h4>
				<p style="margin:0 0 6px">{{ $giverDetail->headline;}}</p>
				<p style="margin:0 0 6px">{{ $giverDetail->location;}}</p>
			</div>
			<div style="clear:both"></div>
			<div class="borderPic">
				<ul style="padding:0">
					<li style="list-style:none;float:left;margin-right:4px">
						<a target="_blank" href="{{$giverDetail->linkedinurl}}"><img src="{{URL::to('/')}}/images/linkdin.png" alt="" height="20px;"></a>
					</li>
					<li style="list-style:none;float:left;margin-right:4px;position:relative">
						<a href="{{URL::to('/')}}/profile/<?php echo strtolower($giverDetail->fname.'-'.$giverDetail->lname).'/'.$giverDetail->id ;?>"><img src="{{URL::to('/')}}/images/krmaicon.png" height="20px" alt=""></a>
		 ...
		 <hr style="height:1px;border:none;border-bottom:1px solid #898989;margin:10px 10%;">
			<ul style="width:380px;margin:0 auto;color: #626262; font-weight: 600;">
				{{$subject}}:   
			</ul> 
			...
			<hr style="height:1px;border:none;border-bottom:1px solid #898989;margin:10px 10%;">
			<ul style="width:380px; margin:0 auto;color: #626262;">
				{{$Points}}
			</ul>      
			<ul style="width:380px;margin:0 auto"> 
