...
<body>
	...
	<!-- Header -->
		...
		<div style="width:280px;background:#fff;border:1px solid #ccc;margin:0 auto;padding:5px">
			...
			<p style="width:380px;margin:0 auto;color: #626262; font-weight: 600;padding-left: 85px;">
				Subject: {{$subject}}  
			</p> 
			<p style="width:380px;margin:0 auto;padding-left: 85px; ">
				{{$Note}} 
			</p> 
			<p style="width:380px;margin:7px auto 0;color: #626262; font-weight: 600;padding-left: 85px;"> 
			...
			<div style="width:380px;margin:0 auto; text-align:center; "> 
                       <a href="{{$url}}" style="text-decoration:none" target="blank"><input type="submit" name="" value="Archive" style="background:#39bb95;color:#fff;font-size:15px;border:none;border-radius:6px;height:38px;width:170px;box-shadow:3px 3px 0px #6acdb1;margin:10px 0 10px 0;cursor:pointer"></a>
					   <a href="{{$url}}" style="text-decoration:none" target="blank"><input type="submit" name="" value="Accept" style="background:#39bb95;color:#fff;font-size:15px;border:none;border-radius:6px;height:38px;width:170px;box-shadow:3px 3px 0px #6acdb1;margin:10px 0 10px 0;cursor:pointer"></a>
            </div>
