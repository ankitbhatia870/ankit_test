	...
	<!-- Header -->
            	...
            	<tr>
	                <th style="font-weight:normal">
	                	<a href="{{URL::to('/')}}" target="_blank">
	                		<img style="max-width:230px;display:block;color: #626262;" src="{{URL::to('/')}}/images/logo.png">
	                	</a>
	                </th>
		...
		<div style="width:280px;background:#fff;border:1px solid #ccc;margin:0 auto;padding:5px">
			...
			<div>
				...
				<p style="margin:0 0 6px; color: #626262;">{{ $receiverDetail->headline;}}</p>
				<p style="margin:0 0 6px; color: #626262;">{{ $receiverDetail->location;}}</p>
			</div> 
