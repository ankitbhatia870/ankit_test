...
@section('content')
<?php //echo '<pre>';print_r($meetingStatus);die; 
                      ...
                      @if ($profileSelf != 1)  
                        <div class="sendReqBTN leftSbtn">
                          ...
                          <?php //echo '<pre>';print_r($CurrentUser);die;?>
                            <a href="{{URL::to('/')}}/meeting/{{$receiverData->fname}}-{{$receiverData->lname}}-{{$giverData->fname}}-{{$giverData->lname}}/{{$checkMeetingStatus['karmaId']}}"><button type="button" class="btn btn-success btnicon meeting">Request Meeting</button></a>
                          @endif
                           <?php //echo '<pre>';print_r($meetingStatus['meetingRunning']);die; ?>
                            @if($meetingStatus['meetingRunning']=='no')   
                            ...
                            @else
                              ...
                              <a href="{{URL::to('/')}}/meeting/{{$receiverData->fname}}-{{$receiverData->lname}}-{{$giverData->fname}}-{{$giverData->lname}}/{{$checkMeetingStatus['karmaId']}}"><button type="button" class="btn btn-warning btnicon">Send KarmaNote</button></a>
                            @endif
                          </div>
                        @else
